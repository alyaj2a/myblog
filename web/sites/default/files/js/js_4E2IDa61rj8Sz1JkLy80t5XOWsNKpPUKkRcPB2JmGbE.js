...
(function ($, Drupal) {
  ...
  Drupal.behaviors.slider1 = {
    attach: function (context, settings) {
      $(document).ready(function(){
     		 $('.communities .view-communities .view-content').not('.slick-initialized').slick({
        		slidesToShow: 7,
        		slidesToScroll: 1,
        		autoplay: true,
            dots: false,
  ...
  Drupal.behaviors.menu_mobile = {
    attach: function (context, settings) {
      $(document).ready(function(){
        $('.top_header_right .menu').slimmenu({
            resizeWidth: '767',
            collapserTitle: 'Menu',
            animSpeed: 'medium',
            indentChildren: true,
...
/*
  Drupal.behaviors.slider = {
    attach: function (context, settings) {
      $(document).ready(function(){
        $('.social_networks .view-social-networks .view-content ').owlCarousel({
          slidesToShow: 3,
          slidesToScroll: 1,
          dots: true,
          margin:10,
